...
const Contact: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-tactical-50 pt-24 pb-16">
        {/* Hero Section */}
        <section className="bg-tactical-900 text-white py-20 md:py-28 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <Mail className="w-16 h-16 mx-auto mb-6 text-accent-500 opacity-80" />
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              {/* Column 1: Email */}
              <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 text-center hover:shadow-xl transition-shadow duration-300">
                <Mail className="w-12 h-12 text-accent-600 mx-auto mb-4" />
                <h3 className="text-xl font-heading font-semibold text-tactical-900 mb-2">Email Support</h3>
                <p className="text-tactical-700 mb-4 text-sm">
                  Send us an email for detailed inquiries.
                </p>
                <a
                  href={`mailto:${emailAddress}`}
                  className="inline-block bg-accent-500 text-white px-5 py-2 rounded-md text-sm font-medium hover:bg-accent-600 transition-colors break-all"
                >
                  {emailAddress}
                </a>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <h3 className="text-xl font-heading font-semibold text-tactical-900 mb-2">WhatsApp Chat</h3>
                <p className="text-tactical-700 mb-4 text-sm">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <h3 className="text-xl font-heading font-semibold text-tactical-900 mb-2">Our Location</h3>
                <p className="text-tactical-700 mb-1 text-sm">
                  S-Arms Shooting Range, Tallinn, Estonia
                </p>
                <p className="text-xs text-tactical-600 italic mb-4">
                  Estonia's Premier Tactical Training Facility
                </p>
                 {/* Optional: Link to map - replace '#' with actual link if available */}
                 <a href="#" className="text-blue-600 hover:text-blue-800 text-sm font-medium">View on Map (Placeholder)</a>
              </div>
            </div>
          </div>
        </section>
